...
while True:
    ...
    while playerChoice!="stand":
        ...
        if playerChoice=="hit":
            ...
            if playerVal>21:
                print("You busted all over the table. Your friends at the table stare at you in shock. The dealer looks weirdly excited. You look back at your cards in shame.")
            break
